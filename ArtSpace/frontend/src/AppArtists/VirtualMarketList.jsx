          ...
          {virtualmarket.map((virtualmarket) => (
            ...
            >
              <img
                ...
                className="w-full h-52 rounded-md shadow-lg object-cover mb-4"
              />
              ...
              <p className="text-gray-600 text-sm">{`العنوان: ${virtualmarket.address}`}</p>
              <p className="text-gray-600 text-sm">{`تفاصيل: ${virtualmarket.details}`}</p>
              <button
